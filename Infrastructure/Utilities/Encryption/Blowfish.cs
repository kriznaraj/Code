...
{
    /// <summary>
    /// Represents blowfish encryption
    /// </summary>
    public class BlowFish : ICloneable
    {
        ...
        /// </summary>
        private const int MAX_KEY_LENGTH = 56;
        ...
        /// <summary>
        /// </summary>
        private static readonly uint[] SBOX_INIT_1 =
        {
        ...
        /// <summary>
        /// </summary>
        private static readonly uint[] SBOX_INIT_2 =
        {
        ...
        /// <summary>
        /// </summary>
        private static readonly uint[] SBOX_INIT_3 =
        {
        ...
        /// <summary>
        /// </summary>
        private static readonly uint[] SBOX_INIT_4 =
        {
        ...
        public BlowFish(byte[] key, int nOfs, int nLen)
        {
            this.Initialize(key, nOfs, nLen);
        }
            ...
            get
            {
                ...
                if (-1 == this.isWeakKey)
                {
                    ...
                    for (nI = 0; nI < SBOX_ENTRIES - 1; nI++)
                    {
                        ...
                        {
                            if ((this.sbox1[nI] == this.sbox1[nJ]) | (this.sbox2[nI] == this.sbox2[nJ]) |
                                (this.sbox3[nI] == this.sbox3[nJ]) | (this.sbox4[nI] == this.sbox4[nJ]))
                            {
                                break;
                            }
                            else
        ...
        /// </returns>
        public int Decrypt(byte[] dataIn, int nPosIn, byte[] dataOut, int nPosOut, int nCount)
        {
            int nEnd;
            uint unHi, unLo;
            ...
            while (nPosIn < nEnd)
            {
                unHi = (((uint)dataIn[nPosIn]) << 24) | (((uint)dataIn[nPosIn + 1]) << 16) |
                       (((uint)dataIn[nPosIn + 2]) << 8) | dataIn[nPosIn + 3];

                unLo = (((uint)dataIn[nPosIn + 4]) << 24) | (((uint)dataIn[nPosIn + 5]) << 16) |
                       (((uint)dataIn[nPosIn + 6]) << 8) | dataIn[nPosIn + 7];
                nPosIn += 8;

                unHi ^= pbox17;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox16;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox15;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox14;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox13;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox12;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox11;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox10;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox09;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox08;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox07;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox06;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox05;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox04;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox03;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox02;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox01;
        ...
        /// </param>
        public void DecryptBlock(uint unHi, uint unLo, out uint unOutHi, out uint unOutLo)
        {
            byte[] block;
            ...
            unOutHi = (((uint)block[0]) << 24) | (((uint)block[1]) << 16) | (((uint)block[2]) << 8) | block[3];

            unOutLo = (((uint)block[4]) << 24) | (((uint)block[5]) << 16) | (((uint)block[6]) << 8) | block[7];
        }
        ...
        public int Encrypt(byte[] dataIn, int nPosIn, byte[] dataOut, int nPosOut, int nCount)
        {
            ...
            while (nPosIn < nEnd)
            {
                ...
                unHi ^= pbox00;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox01;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox02;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox03;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox04;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox05;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox06;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox07;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox08;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox09;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox10;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox11;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox12;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox13;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox14;
                unLo ^= (((sbox1[(Int32)(unHi >> 24)] + sbox2[(Int32)((unHi >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unHi >> 8) & 0x0ff)]) + sbox4[(Int32)(unHi & 0x0ff)]) ^ pbox15;
                unHi ^= (((sbox1[(Int32)(unLo >> 24)] + sbox2[(Int32)((unLo >> 16) & 0x0ff)]) ^
                          sbox3[(Int32)((unLo >> 8) & 0x0ff)]) + sbox4[(Int32)(unLo & 0x0ff)]) ^ pbox16;
        ...
        public void Initialize(byte[] key, int nOfs, int nLen)
        {
            ...
            {
                this.EncryptBlock(unHi, unLo, out unHi, out unLo);
                box[nI++] = unHi;
                box[nI++] = unLo;
            }
        ...
        /// <summary>
        /// Returns an identica, non-shallow copy of the current instance.
