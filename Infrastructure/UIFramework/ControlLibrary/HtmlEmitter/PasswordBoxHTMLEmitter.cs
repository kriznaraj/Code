...
{
    internal class PasswordBoxHTMLEmitter : ControlHTMLEmitter
    {
        #region "Member Variables"

        private PasswordBoxPropertyBag _propertyBag;
        ...
        public PasswordBoxHTMLEmitter(string value, PasswordBoxPropertyBag propertyBag)
        ...
        private string BuildTextBox()
        {
            ...
            this.SetAttribute(controlTag, ATTRIBUTE_TYPE, ATTR_VAL_PASSWORD);
