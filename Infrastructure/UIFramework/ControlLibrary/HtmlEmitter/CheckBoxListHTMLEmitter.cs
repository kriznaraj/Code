...
{
    internal class CheckBoxListHTMLEmitter : ControlHTMLEmitter
    {
        #region "Member Variables"

        private CheckBoxListPropertyBag _propertyBag;
        ...
        public CheckBoxListHTMLEmitter(string value, CheckBoxListPropertyBag propertyBag)
        ...
        private string BuildList()
        {
            ...
            this.SetAttribute(div, ATTRIBUTE_DATA_BCHECKLIST, VAL_TRUE);
        ...
        private string buildInputTag(string[] checkBoxItem)
        {
            ...
            this.SetAttribute(input, ATTRIBUTE_TYPE, ATTR_VAL_CHECKBOX);
            this.SetAttribute(input, ATTRIBUTE_VALUE, checkBoxItem[0]);
            this.SetAttribute(input, ATTRIBUTE_NAME, "chk_" + _propertyBag.ControlName);
