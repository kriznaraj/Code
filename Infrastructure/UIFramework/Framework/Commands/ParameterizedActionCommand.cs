...
{
    public abstract class ParameterizedActionCommand<T>: ICommand
        where T : ViewModelBase
    {
        ...
        public abstract void Do(IExecutionContext executionCtx, ISessionContext sessionCtx, T viewModel);
        ...
        {
            ControllerConfigurator.utilityProvider.GetLogger().LogFatal("Parameterized.ExecuteProcess", exception);
